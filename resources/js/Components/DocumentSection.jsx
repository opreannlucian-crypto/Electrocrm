...
export default function DocumentSection({ documents = [], parentId, storeRoute, downloadRoute, destroyRoute, canDelete = true, title = "Documente" }) {
