...
export default function Index({ revisions, clients = [], filters = {}, today }) {
    ...
    const filterForm = useForm({ client: filters.client || "", type: filters.type || "", period: filters.period || "", status: filters.status || "" });
